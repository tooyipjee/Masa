/*!
 * @file  Masa_SHT20.cpp
 * @brief  Define the basic structure of class Masa_SHT20
 ...
 * @version  V1.0
 * @date  2021-12-03
 * @url  https://github.com/DFRobot/Masa_SHT20
 */
#include "Masa_SHT20.h"

Masa_SHT20::Masa_SHT20(TwoWire *pWire, uint8_t sht20Addr)
{
  _addr = sht20Addr;
  _pWire = pWire;
}

void Masa_SHT20::initSHT20()
{
    _pWire->begin(10,11);
}

float Masa_SHT20::readHumidity(void)
{
...
float Masa_SHT20::readTemperature(void)
{
...
void Masa_SHT20::checkSHT20(void)
{
...
void Masa_SHT20::setResolution(byte resolution)
{
...
byte Masa_SHT20::readUserRegister(void)
{
    byte userRegister;
...
void Masa_SHT20::writeUserRegister(byte val)
{
    _pWire->beginTransmission(_addr);
...
void Masa_SHT20::showReslut(const char *prefix, int val)
{
    Serial.print(prefix);
    if(val){
        Serial.println("yes");
...
byte Masa_SHT20::checkCRC(uint16_t message_from_sensor, uint8_t check_value_from_sensor)
{
...
uint16_t Masa_SHT20::readValue(byte cmd)
{
    _pWire->beginTransmission(_addr);
    _pWire->write(cmd);
