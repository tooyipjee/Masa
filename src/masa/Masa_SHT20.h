/*!
 * @file  Masa_SHT20.h
 * @brief  Define infrastructure of Masa_SHT20 class
 ...
 */
#ifndef __Masa_SHT20_H__
#define __Masa_SHT20_H__
...
public:
   ...
   * @return None
   */
  Masa_SHT20(TwoWire *pWire=&Wire, uint8_t sht20Addr=SHT20_I2C_ADDR);
